...
/// egui を用いたデバッグウィンドウの描画とイベント処理をまとめたレンダラー。
...
impl DebugRenderer {
    ...
    pub fn render(
        ...
        let mut full_output = self.egui_context.run_ui(raw_input, |ui| {
            egui::CentralPanel::default().show(ui, |ui| {
                ...
                egui::Grid::new("debug_metrics")
                    ...
                    .show(ui, |ui| {
                        ui.label("Main loop");
                        ui.label(format!("{:.1} Hz", loops_per_second));
                        ui.end_row();
                        ui.label("Render");
                        ui.label(format!("{:.1} FPS", frames_per_second));
                        ui.end_row();
