...
pub fn lane_is_pressed(
    keys: &bevy::prelude::ButtonInput<bevy::prelude::KeyCode>,
    lane_index: usize,
) -> bool {
    match lane_index {
        0 => keys.pressed(bevy::prelude::KeyCode::KeyS),
        1 => keys.pressed(bevy::prelude::KeyCode::KeyD),
        2 => keys.pressed(bevy::prelude::KeyCode::KeyF),
        3 => keys.pressed(bevy::prelude::KeyCode::Space),
        4 => keys.pressed(bevy::prelude::KeyCode::KeyJ),
        5 => keys.pressed(bevy::prelude::KeyCode::KeyK),
        6 => keys.pressed(bevy::prelude::KeyCode::KeyL),
        7 => {
...
pub fn lane_is_just_pressed(
    keys: &bevy::prelude::ButtonInput<bevy::prelude::KeyCode>,
    lane_index: usize,
) -> bool {
    match lane_index {
        0 => keys.just_pressed(bevy::prelude::KeyCode::KeyS),
        1 => keys.just_pressed(bevy::prelude::KeyCode::KeyD),
        2 => keys.just_pressed(bevy::prelude::KeyCode::KeyF),
        3 => keys.just_pressed(bevy::prelude::KeyCode::Space),
        4 => keys.just_pressed(bevy::prelude::KeyCode::KeyJ),
        5 => keys.just_pressed(bevy::prelude::KeyCode::KeyK),
        6 => keys.just_pressed(bevy::prelude::KeyCode::KeyL),
        7 => {
            keys.just_pressed(bevy::prelude::KeyCode::ShiftLeft)
                || keys.just_pressed(bevy::prelude::KeyCode::ShiftRight)
        }
        _ => false,
    }
}
